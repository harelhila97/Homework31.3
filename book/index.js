...
// var result = findbookbyname(bookname)
// console.log(result)
...
//     for (let index = 0; index < books.length; index++) {
//         var book = books[index];
//         if (book.author.toLowerCase() === bookauthor.toLowerCase()) {
//             return book
//         }   
//     }
// }

// var result = findbookbyauthor(bookauthor)
// console.log(result)

var bookname = prompt("Enter book name:")
var prop = prompt("enter key to change: ")
var newvelue = prompt("enter new velue")
editbook(bookname, prop, newvelue)

function editbook(booktitle, prop, newvalue) {
    if (typeof bookname !== 'string') return;
    if (typeof prop !== 'string') return;
    booktitle = booktitle.toLowerCase()
    prop = prop.toLowerCase()
    var book = books.find(function (currentbook) { return currentbook.title.toLocaleLowerCase() === booktitle })
    if (book) {
        book[prop] = newvalue;
    }
    // for (let index = 0; index < books.length; index++) {
    //     var book = books[index];
    //     if (book.title.toLocaleLowerCase() === booktitle) {
    //         book[prop] = newvelue;
    //     }
    // }
}
